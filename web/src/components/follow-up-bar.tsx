...
export function FollowUpBar({ chips, onRemoveChip, onSubmit }: FollowUpBarProps) {
  ...
  return (
    <div className="shrink-0 border-t border-ink-subtle pl-[var(--shell-utility-inset)] pr-4 md:pr-10 pt-3 pb-3.5 flex flex-col gap-2 animate-[slide-up_0.28s_cubic-bezier(0.4,0,0.2,1)]">
      {chips.length > 0 && (
