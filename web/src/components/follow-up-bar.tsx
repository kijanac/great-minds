...
export function FollowUpBar({ chips, onRemoveChip, onSubmit }: FollowUpBarProps) {
  ...
  return (
    <div className="shrink-0 border-t border-ink-subtle pl-[var(--shell-utility-inset)] pr-4 md:pr-10 pt-3 pb-3.5 animate-[slide-up_0.28s_cubic-bezier(0.4,0,0.2,1)]">
      <div className="max-w-[740px] mx-auto w-full flex flex-col gap-2">
        {chips.length > 0 && (
        ...
        <div className="flex items-center">
          <Input
            className="flex-1 h-auto bg-transparent dark:bg-transparent border-0 border-b border-b-gold-dim rounded-none text-warm-dim font-serif text-[length:var(--text-small)] py-[3px] px-0 caret-gold placeholder:text-interactive-dim focus-visible:ring-0 focus-visible:border-b-gold transition-colors"
